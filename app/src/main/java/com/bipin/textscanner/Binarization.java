...
public class Binarization extends AppCompatActivity implements View.OnClickListener, AppCompatSeekBar.OnSeekBarChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ArrayAdapter adapter = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, Arrays.asList("English", "Spanish", "Hindi", "Marathi"));
       ...
       /* MyTestActivity myTestActivity = new MyTestActivity(Binarization.this, "mar");
        String ocrResult = myTestActivity.getOCRResult(umbralization);
        Log.d(TAG, "onCreate: " + ocrResult);*/

    }

    private static final String TAG = "Binarization";
    ...
    public void onStopTrackingTouch(SeekBar seekBar) {
        ...
        umbralization = com.googlecode.leptonica.android.WriteFile.writeBitmap(
                ...
                //GrayQuant.pixThresholdToBinary(pix, 20)
        );
        img.setImageBitmap(umbralization);
